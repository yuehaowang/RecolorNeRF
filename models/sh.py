...
C4 = (2.5033429417967046, -1.7701307697799304, 0.9461746957575601, -0.6690465435572892, 0.10578554691520431,
...
def eval_sh_bases(deg, dirs):
    ...
    At each point, the final result may to be obtained through simple multiplication
    :param deg: int SH max degree. Currently, 0-4 supported
