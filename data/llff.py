...
class LLFFDataset(Dataset):
    ...
    def read_meta(self):
        ...
        image_folder_name = f'images_{int(self.downsample)}' if self.downsample > 1 else 'images'
        if not os.path.exists(os.path.join(self.root_dir, image_folder_name)):
        ...
        self.image_paths = sorted(glob.glob(os.path.join(self.root_dir, f'{image_folder_name}/*')))
